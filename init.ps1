...
try {
    ...
    & $mkcert -install
    & $mkcert "*.contosoproject.localhost"
...
Add-HostsEntry "cm.contosoproject.localhost"
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.contosoproject.localhost"
}
Add-HostsEntry "id.contosoproject.localhost"
Add-HostsEntry "www.contosoproject.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.contosoproject.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.contosoproject.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.contosoproject.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.contosoproject.localhost"
